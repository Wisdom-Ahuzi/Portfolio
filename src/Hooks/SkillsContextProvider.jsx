...
export const SkillsContextProvider = ({children}) => {
  const size = 30;
    ...
    const Projects = [
        ...
        {
        prImg:require("../Assets/charlar.png"),
        prName:"Charlar Chat App",
        prSiteLink:"https://github.com/Wizzy-05/Charlar",
        prDes:"Charlar is a simple chat web-app built with React, Sass and Socket.io. It allows you to send and receive end to end messages. It harnesses the browsers Local Storage for storing messages",
        gitLink:"https://github.com/Wizzy-05/Charlar"
        },
        {
